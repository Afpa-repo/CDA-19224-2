...
class __TwigTemplate_9d33e407dbef1f270ee24dbc961175bf037b35087b42d6b51dae9e40752c195d extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"row\">
    ...
    <div class=\"col md-4\">";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "category", [], "any", false, false, false, 6), 'row');
        echo "</div>
    <div class=\"col md-4\">";
        // line 7
...
<button class=\"btn btn-primary\">";
        // line 13
        echo twig_escape_filter($this->env, (((isset($context["button"]) || array_key_exists("button", $context))) ? (_twig_default_filter((isset($context["button"]) || array_key_exists("button", $context) ? $context["button"] : (function () { throw new RuntimeError('Variable "button" does not exist.', 13, $this->source); })()), "Enregistrer")) : ("Enregistrer")), "html", null, true);
        echo "</button>
";
        // line 14
...
";
    ...
    {
        return array (  80 => 14,  76 => 13,  72 => 12,  67 => 10,  61 => 7,  57 => 6,  53 => 5,  48 => 3,  45 => 2,  43 => 1,);
    }
...
<div class=\"row\">
    <div class=\"col md-2\">{{ form_row(form.description) }}</div>
</div>
{{ form_rest(form) }}
<button class=\"btn btn-primary\">{{ button|default('Enregistrer') }}</button>
{{ form_end(form) }}
", "admin/property/_form.html.twig", "C:\\Users\\Windows-Famille\\Documents\\CDA-19224-2\\ProjetFilRouge\\templates\\admin\\property\\_form.html.twig");
    }
}
